...
(() => {
  ...
  var MazeSolvingAlgorithm2 = class {
  ...
  var BFS = class extends MazeSolvingAlgorithm2 {
  ...
  var GBFS = class extends MazeSolvingAlgorithm2 {
    constructor(config2, maze2) {
      super(config2, maze2);
  ...
  var ASTAR = class extends MazeSolvingAlgorithm2 {
    constructor(config2, maze2) {
      super(config2, maze2);
      this.search_frontier = [];
      if (maze2.start === void 0 || maze2.end === void 0)
